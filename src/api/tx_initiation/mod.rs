...
//!
//! note: The only API that xnt-core truly needs for transaction initiation
...
//! generating a `SingleProof` yourself, outside xnt-core. This requires a
...
//!  5. record and broadcast the transaction.
//!
//!  (6-8 are internal to xnt-core)
//!
//!  6. xnt-core broadcasts the transaction to other nodes.
