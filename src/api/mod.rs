//! public api for common xnt-core operations
//!
//! The xnt-core library crate has been implemented to build the
//! xnt-core (binary) server.  As such, it was not built with a cohesive
//! public API in mind.
//!
//! This module aims to:
...
//!
//! ```no_run
//! use neptune_privacy::api::export;
