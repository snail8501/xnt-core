...
mod transaction {
    ...
    use neptune_privacy::protocol::consensus::transaction::validity::collect_lock_scripts::CollectLockScripts;
    ...
    use neptune_privacy::protocol::consensus::transaction::validity::removal_records_integrity::RemovalRecordsIntegrity;
    use neptune_privacy::protocol::consensus::transaction::validity::removal_records_integrity::RemovalRecordsIntegrityWitness;
    use neptune_privacy::protocol::consensus::type_scripts::native_currency::NativeCurrency;
    use neptune_privacy::protocol::consensus::type_scripts::native_currency::NativeCurrencyWitness;
    use neptune_privacy::protocol::consensus::type_scripts::time_lock::neptune_arbitrary::arbitrary_primitive_witness_with_active_timelocks;
    use neptune_privacy::protocol::consensus::type_scripts::time_lock::neptune_arbitrary::arbitrary_primitive_witness_with_expired_timelocks;
    use neptune_privacy::protocol::consensus::type_scripts::time_lock::TimeLock;
    use neptune_privacy::protocol::consensus::type_scripts::time_lock::TimeLockWitness;
