...
//! # use neptune_privacy::api::tx_initiation::builder::transaction_details_builder::TransactionDetailsBuilder;
//! # use neptune_privacy::api::tx_initiation::builder::transaction_builder::TransactionBuilder;
//! # use neptune_privacy::api::tx_initiation::builder::triton_vm_proof_job_options_builder::TritonVmProofJobOptionsBuilder;
//! # use neptune_privacy::api::tx_initiation::builder::tx_artifacts_builder::TxCreationArtifactsBuilder;
//! # use neptune_privacy::api::tx_initiation::builder::tx_output_list_builder::TxOutputListBuilder;
//! # use neptune_privacy::api::tx_initiation::builder::tx_input_list_builder::TxInputListBuilder;
...
//! # use neptune_privacy::api::export::GlobalStateLock;
//! # use neptune_privacy::api::export::InputSelectionPolicy;
...
//! ```
//!
//! # case: Client generates `SingleProof` outside xnt-core
//!
