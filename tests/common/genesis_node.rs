...
use neptune_privacy::application::config::cli_args::Args;
...
impl GenesisNode {
    ...
    /// provides default xnt-core cli arguments for typical integration tests.
    ...
    ///
    /// when a transaction is accepted by xnt-core it may take a short
